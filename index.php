    ...
    <div id="home-carousel" class="carousel slide" data-interval="false">
        ...
        <div class="carousel-inner">
            <div class="item active"  style="background-image: url('img/slider/bg2.jpg')" >
                <div class="row">
                    <div class="carousel-caption col-md-4 col-md-offset-1">
                        <div class="animated bounceInRight create">
                            <h2 style="margin-bottom: 30px;">Create new trip destination</h2>
                            <form action="create_room_check.php" method="POST" class="forms form-horizontal">
                                    <div class="form-group">
                                        <label for="nama_room" class="col-sm-4 control-label" style="font-size:1.4em;"> Nama Room</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="nama_room" placeholder="Room Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="destinasi" class="col-sm-4 control-label" style="font-size: 1.4em;">Destinasi</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="destinasi" placeholder="Destinasi" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggal" class="col-sm-4 control-label" style="font-size:1.4em;">Tanggal</label>
                                        <div class="col-sm-8">    
                                            <input type="date" class="form-control" name="tanggal" placeholder="Tanggal Keberangkatan" value="<?php echo $today->format("Y-m-d"); ?>" min="<?php echo $today->format("Y-m-d")?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="kuota" class="col-sm-4 control-label" style="font-size:1.4em;">Kuota</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="kuota" placeholder="Kuota" required>
                                        </div>
                                    </div>
                                    <input type="hidden" name="id_ketua" value="<?php echo $_SESSION['user']['id'] ?>">    
                                    <button type="submit" class="form-control btn btn-default" style="width: 25%;">Submit</button>
                            </form>
                        </div>
                    </div>
                    <div class="carousel-caption col-md-2">
                        <div class="animated bounceInRight or text-center" style="padding: 0 !important;background-color: transparent;">
                            <h2 style="margin: 0;padding: 15px 0;">OR</h2>
                        </div>
                    </div>
                    <div class="carousel-caption col-md-4">
                        <div class="animated bounceInRight join" style="background-color: transparent;">
                            <form action="destination.php">
                                <input type="submit" class="form-control btn btn-warning" value="Join available trip" style="height: 50px;font-size: 1.3em;font-weight: 600;">
                            </form>
                        </div>
                    </div>
                </div>
...
<section id="portfolio">
    <div class="section-title text-center wow fadeInDown">
        ...
        <!-- <p>Bingung mau kemana? Ini nih beberapa saran kita~</p> -->
    </div>
    <nav class="project-filter clearfix text-center wow fadeInLeft"  data-wow-delay="0.5s">
        <ul class="list-inline">
            <li><a href="javascript:;" class="filter" data-filter="all">Semua</a></li>
            <!-- <li><a href="javascript:;" class="filter" data-filter=".app">DKI Jakarta</a></li> -->
            <li><a href="javascript:;" class="filter" data-filter=".bali">Bali</a></li>
            <li><a href="javascript:;" class="filter" data-filter=".dki_jakarta">DKI Jakarta</a></li>
            <li><a href="javascript:;" class="filter" data-filter=".jawa_barat">Jawa Barat</a></li>
            <li><a href="javascript:;" class="filter" data-filter=".jawa_tengah">Jawa Tengah</a></li>
            <li><a href="javascript:;" class="filter" data-filter=".jawa_timur">Jawa Timur</a></li>
            <li><a href="javascript:;" class="filter" data-filter=".banten">Banten</a></li>
            <li><a href="javascript:;" class="filter" data-filter=".diy">DIY</a></li>
        </ul>
    </nav>
    <div id="projects" class="clearfix">
        <figure class="mix portfolio-item bali">
            <img class="img-responsive" src="img/portfolio/bali_1.jpg" alt="Portfolio Item">
            <a href="img/portfolio/bali_1.jpg" title="Title One" rel="portfolio" class="fancybox"><span class="plus"></span></a>
            <figcaption class="mask maask">
                <h3>Upacara Ngaben</h3>
                <span>Bali</span>
            </figcaption>
        </figure>
        <figure class="mix portfolio-item jawa_tengah">
            <img class="img-responsive" src="img/portfolio/jawa_tengah_1.jpg" alt="Portfolio Item">
            <a href="img/portfolio/jawa_tengah_1.jpg" title="Title One" rel="portfolio" class="fancybox"><span class="plus"></span></a>
            <figcaption class="mask maask">
                <h3>Kampung Batik</h3>
        ...
        <figure class="mix portfolio-item jawa_tengah">
            <img class="img-responsive" src="img/portfolio/jawa_tengah_2.jpg" alt="Portfolio Item">
            <a href="img/portfolio/jawa_tengah_2.jpg" title="Title One" rel="portfolio" class="fancybox"><span class="plus"></span></a>
            <figcaption class="mask maask">
                <h3>Candi Borobudur</h3>
                <span>Magelang, Jawa Tengah</span>
            </figcaption>
        </figure>
        <figure class="mix portfolio-item jawa_barat">
            <img class="img-responsive" src="img/portfolio/jawa_barat_1.jpg" alt="Portfolio Item">
            <a href="img/portfolio/jawa_barat_1.jpg" title="Title One" rel="portfolio" class="fancybox"><span class="plus"></span></a>
            <figcaption class="mask maask">
                <h3>Saung Angklung Udjo</h3>
                <span>Bandung, Jawa Timur</span>
            </figcaption>
        </figure>
    </div> <!-- end #projects -->
</section>
