...
if(isset($_POST["username"]) && isset($_POST["password"]) && isset($_POST["nama"]) && isset($_POST["kota_asal"]) && isset($_POST["kota_lahir"]) && isset($_POST["tanggal_lahir"])  && isset($_POST["no_hp"]))
{
		// echo "argh";
